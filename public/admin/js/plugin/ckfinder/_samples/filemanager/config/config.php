...
$upload_dir = '/upload/library/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../upload/library/'; // relative path from filemanager folder to upload folder (with final /)
